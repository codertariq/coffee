...
var DatatableButtonsHtml5 = function() {
    ...
    var _componentDatatableButtonsHtml5 = function() {
        ...
        tariq = $('.broker_managment_table').DataTable({
            buttons: {
                dom: {
                    button: {
    ...
    var _componentAjaxgetPage = function() {
        $(document).on('click', '#broker_managment', function(e) {
            e.preventDefault();
    ...
    var _componentValidation = function() {
        ...
        // Initialize
        var validator = $('#broker-form').validate({
            ...
            submitHandler: function(e) {
                ...
                $('#submiting').show();
                $(".ajax_error").remove();
                var submit_url = $('#broker-form').attr('action');
                //Start Ajax
                var formData = new FormData($("#broker-form")[0]);
                $.ajax({
                    url: submit_url,
                    type: 'POST',
                    data: formData,
    ...
    var _componentChangeStatus = function() {
        $(document).on('click', '#change_status', function(e) {
            ...
            if (status == 1) {
                msg = 'Change Broker Status Form Online To Offline';
            } else {
                msg = 'Change Broker Status Form Offline To Online';
            }
            $('#action_menu_' + row).hide();
            $('#delete_loading_' + row).show();
            //console.log(row, url);
