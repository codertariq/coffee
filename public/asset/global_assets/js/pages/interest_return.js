...
var DatatableButtonsHtml5 = function() {
    ...
    var _componentGetSavingsDetails = function() {
        $(document).on('change', '#member_id', function(){
            $('#calculate').show();
            $('#savings_details').html('Please Interest Rate and Calculate For Savings Details');
        ...
        $(document).on('click', '#calculate', function() {
           ...
           $('#savings_loader').show();
            ...
            $.ajax({
                    url: Base_url + 'return/savings/interest/savings_details',
                    type: 'Post',
                    data: {
                        member_id: member_id,
        ...
        $(document).on('keydown', '#interest_rate', function(e) {
            //console.log('Tariq');
            if (e.keyCode == 13) {
            $('#savings_loader').show();
            var member_id = $('#member_id').val();
...
$(document).on('keyup', '#back_interest', function() {
    ...
    var back_interest = parseFloat($(this).val());
    if (back_interest > total_savings_interest) {
        swal({
            title: "Are You Sure?",
...
function calculateBackInterest() {
    ...
    var interest_rate = (interest_rate * savings_duration) / (100 * 365)
...
$(document).on('keyup', '#interest_rate', function(){
    ...
    if(rate > 100){
        swal({
            title: "Stop!",
            text: 'You Can Not Give more than 100% interest.',
            icon: "warning",
            buttons: true,
            dangerMode: true,
        });
