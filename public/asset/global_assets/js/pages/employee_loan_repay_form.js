...
var DatatableButtonsHtml5 = function() {
    ...
    var _componentGetLoanField = function() {
        $(document).on('change', '#employee_id', function() {
            var employee_id = $(this).val(); // it will get action url
            //console.log(json_encode(method));
            $.ajax({
                    url: Base_url + 'repay/loan/employee/loan',
                    type: 'Post',
                    data: {
    ...
    var _componentGetLoanDetails = function() {
        $(document).on('change', '#loan_id', function() {
            ...
            $.ajax({
                    url: Base_url + 'repay/loan/employee/loan_details',
                    type: 'Post',
                    data: {
                        employee_id: employee_id,
                        loan_id: loan_id
                ...
                .done(function(data) {
                    //console.log(data);
                    getLoanDetailInfo(employee_id, loan_id);
