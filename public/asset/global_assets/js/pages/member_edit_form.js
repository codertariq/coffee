...
var DatatableButtonsHtml5 = function() {
    ...
    var _componentDatePicker = function() {
        ...
        // console.log(local);
        $('#dob, #nomenne_dob, #joining_date').daterangepicker({
    ...
    var _componentCheckMember = function() {
        $(document).on('change', '#referance_employee_no', function() {
           ...
           $.ajax({
                ...
                .done(function(data) {
                    $('#referance_employee_no').after('<div class="refarance_member text-'+data.status+'">' + data.message + '</div');
                })
                .fail(function(data) {
                    console.log(data);
                });
    ...
    var _componentValidation = function() {
        ...
        var validator = $('#content_form').validate({
            ...
            submitHandler: function(e) {
                ...
                var submit_method = $('input[name="_method"]').val();
...
$(document).ready(function(){
    $(document).on('click', '#upload_image', function(){
        $('#upload_image_field').toggle();
        $('#delete_image').prop('checked',false);
        $.uniform.update();
        //console.log($('#upload_image_field').attr('style'));
    });
    $(document).on('click', '#delete_image', function(){
        var display = $('#upload_image_field').attr('style');
        if (display == '') {
            $('#upload_image_field').attr('style', 'display: none');
        }
