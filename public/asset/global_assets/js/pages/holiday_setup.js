...
var DatatableButtonsHtml5 = function() {
    ...
    var _componentDatatableButtonsHtml5 = function() {
        ...
        tariq = $('.content_managment_table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: Base_url+'setup/holiday/datatable',
            columns: [{
                data: 'id',
                name: 'id'
            }, {
        ...
        $(document).on('click', '#content_managment', function(e) {
            ...
            $.ajax({
                ...
                .done(function(data) {
                    ...
                    _componentDatatable();
                    _componentSelect2();
                    _componentFormDatePicker();
                    _componentToDatePicker();
                    // hide ajax loader
                })
                .fail(function(data) {
                    console.log(data);
    ...
    var _componentFormDatePicker = function() {
     ...
     var _componentToDatePicker = function() {
        //console.log(estimate_time)
        var local = $('#from_date').val();
        // console.log(local);
